...
#define kSCREEN_ADJUST(Value)  [UIScreen mainScreen].bounds.size.width * (Value) / 375.0

#define kActionItemHeight     kSCREEN_ADJUST(50)
#define kLineHeight           0.5
#define kDividerHeight        7.5

#define kTitleFontSize        kSCREEN_ADJUST(15)
#define kActionItemFontSize   kSCREEN_ADJUST(17)
